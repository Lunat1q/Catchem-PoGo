...
namespace Catchem.Classes
{
    public class WpfEventListener
    {
        ...
        public void HandleEvent(PokemonEvolveDoneEvent evt, ISession session)
        {
            ...
            Logger.PushToUi("pm_new", session, evt.Uid, evt.Id, evt.Cp, evt.Perfection, evt.Family, evt.Candy, evt.Level, evt.Move1, evt.Move2);
        }
        ...
        public void HandleEvent(EggHatchedEvent evt, ISession session)
        {
            Logger.Write(session.Translation.GetTranslation(TranslationString.IncubatorEggHatched,
                ...
                LogLevel.Egg, session: session);
            Logger.PushToUi("pm_new", session, evt.Id, evt.PokemonId, evt.Cp, evt.Perfection, evt.Family, evt.Candy, evt.Level, evt.Move1, evt.Move2);
        }
        ...
        public void HandleEvent(PokemonCaptureEvent evt, ISession session)
        {
            ...
            switch (evt.Status)
            {
                ...
                case CatchPokemonResponse.Types.CatchStatus.CatchSuccess:
                    ...
                    Logger.PushToUi("pm_new", session, evt.Uid, evt.Id, evt.Cp, evt.Perfection, evt.Family, evt.FamilyCandies, evt.Level, evt.Move1, evt.Move2);
                    break;
                default:
