...
namespace PoGo.PokeMobBot.Logic.Common
{
    ...
    public enum TranslationString
    {
        ...
        ForceMove,
        ForceMoveDone,
        InventorySettingsFailed,
        ReadTos,
        GenderSelect,
        TutorialPokestop,
        TutorialPoke,
        TutorialNameNotPicked,
        TutorialNameTooLong,
        TutorialNameDone,
        TutorialNameFailed,
        TutorialNameErrorUnset,
        TutorialNameErrorChanged,
        TutorialNameErrorNotAvail,
        TutorialNameErrorNotValid,
        TutorialNameErrorOwner,
        TutorialNameErrorNoMore,
        CantGetAPIVersion,
        OldAPIErr,
        APIVersionOK,
        //NEW 15.11.2016 - Lunatiq
        NianticPlayerWarn,
        NianticPlayerBanned
    }
    ...
    public class Translation : ITranslation
    {
        ...
        private readonly List<KeyValuePair<TranslationString, string>>
            _translationStrings = TranslationStrings;
        //Default Translations (ENGLISH)        
        private static readonly List<KeyValuePair<TranslationString, string>> TranslationStrings = new List
            <KeyValuePair<TranslationString, string>>
        {
            //NEW 15.11.2016 - Lunatiq
            new KeyValuePair<TranslationString, string>(TranslationString.NianticPlayerWarn,
                "Niantic warn message about bot usage! Please, stop using it!"),
             new KeyValuePair<TranslationString, string>(TranslationString.NianticPlayerBanned,
                "Niantic ban message! You are done, sorry!"),
            //NEW TRANSLATION FOR CATCHEM! OLD
            new KeyValuePair<TranslationString, string>(TranslationString.SetLure,
                "Set lure at PokeStop: {0}, distance: {1}, lures left: {2}"),
            new KeyValuePair<TranslationString, string>(TranslationString.LevelUp,
                "Level up! Rewards: "),
            new KeyValuePair<TranslationString, string>(TranslationString.EvolvedInto,
                //$"Evolved into {evt.Id} CP: {evt.Cp} Iv: {evt.Perfection.ToString("0.00")}%"
                "Evolved into {0} CP: {1} Iv: {2}%"),
            //$"Touched a gym: {evt.Name}{gymDesc} - {evt.GymState.FortData.OwnedByTeam}, points: {evt.GymState.FortData.GymPoints}, Guards: {guardList}) "
            new KeyValuePair<TranslationString, string>(TranslationString.GymTouch,
                "Touched a gym: {0}{1} - {2}, points: {3}, Guards: {4}) "),
            new KeyValuePair<TranslationString, string>(TranslationString.EggFound,
                "Found an egg, distance: {0}km from PokeStop: {1}"),
            new KeyValuePair<TranslationString, string>(TranslationString.PokeListEmpty,
                "Highests Pokemon List is empty"),
            new KeyValuePair<TranslationString, string>(TranslationString.ProxyAlready,
                "{0} is already running with this proxy!"),
            new KeyValuePair<TranslationString, string>(TranslationString.YourIpProxyIp,
                "Your IP is: {0} / Proxy IP is: {1}"),
            new KeyValuePair<TranslationString, string>(TranslationString.IpMatch,
                "Your ip match! I warned you!"),
            new KeyValuePair<TranslationString, string>(TranslationString.YourIpIs,
                "Your IP is: {0}"),
            new KeyValuePair<TranslationString, string>(TranslationString.ProxyDown,
                "Proxy Down? Will try to interact with server anyway"),
            new KeyValuePair<TranslationString, string>(TranslationString.HourRateReached,
                "Max amount of Pokemon ({0})/Pokestops ({1})/XP ({2})/Star Dust ({3}) per hour reached, bot will be stopped for {4} minutes"),
            new KeyValuePair<TranslationString, string>(TranslationString.BotPauseCancel,
                "Bot pause routine canceled"),
            new KeyValuePair<TranslationString, string>(TranslationString.BotPauseFail,
                "Bot pause routine failed badly"),
            new KeyValuePair<TranslationString, string>(TranslationString.UpdatesAt,
                "During that pause, consider to check fresh updates at"),
            new KeyValuePair<TranslationString, string>(TranslationString.DiscordLink,
                "or join our friendly Discord chat:"),
            new KeyValuePair<TranslationString, string>(TranslationString.ScheduleAction,
                "Schedule Action [{0}], with args: [{1}] performed successfully"),
            new KeyValuePair<TranslationString, string>(TranslationString.ScheduleActionFailed,
                "Schedule Action Failed to perform action {0}, with args: {1}"),
            new KeyValuePair<TranslationString, string>(TranslationString.SchedulePause,
                "Bot paused for {0}h, case of Schedule settings, will be started again at {1}, {2}:{3}"),
            new KeyValuePair<TranslationString, string>(TranslationString.ThrowPokeball,
                "Throwing {0}{1}{2} - {3}"),
            new KeyValuePair<TranslationString, string>(TranslationString.FoundHiding,
                "Found some hiding poke in the area, trying to catch'em now!"),
            new KeyValuePair<TranslationString, string>(TranslationString.PokeInGym,
                "Pokemon {0} is signed to defend a GYM!"),
            new KeyValuePair<TranslationString, string>(TranslationString.FailedCoords,
                "Coordinate failure, please check them again!"),
            new KeyValuePair<TranslationString, string>(TranslationString.ErrorCatchNearby,
                "Error during catch process!"),
            new KeyValuePair<TranslationString, string>(TranslationString.CandyMiss,
                "Miss some candies to evolve {0} - {1}, cancelling..."),
            new KeyValuePair<TranslationString, string>(TranslationString.NoRoute,
                "No proper route loaded, or route is too short"),
            new KeyValuePair<TranslationString, string>(TranslationString.CustomRouteData,
                "You are using a custom route named: '{0}' with {1} routing points"),
            new KeyValuePair<TranslationString, string>(TranslationString.UnDoneForceMove,
                "Found not-done ForceMove, resuming movement to Lat: {0} Lon:{1}"),
            new KeyValuePair<TranslationString, string>(TranslationString.RouteSwitched,
                "Route switched from {0} to {1}!"),
            new KeyValuePair<TranslationString, string>(TranslationString.CustomRouteDisabled,
                "CustomRoute disabled, going back to normal routine!"),
            new KeyValuePair<TranslationString, string>(TranslationString.FoundClosest,
                "Found closest point at {0} - {1}, distance to that point: {2} meters, moving there!"),
            new KeyValuePair<TranslationString, string>(TranslationString.CustomRouteEnabled,
                "CustomRoute enabled, shutting down normal routine!"),
            new KeyValuePair<TranslationString, string>(TranslationString.ForceMove,
                "ForceMove to {0} - {1} Started! Distance: {2}m"),
            new KeyValuePair<TranslationString, string>(TranslationString.ForceMoveDone,
                "ForceMove Done!"),
            new KeyValuePair<TranslationString, string>(TranslationString.InventorySettingsFailed,
                "You have failed with item settings! You asked to keep it at {0} clean, which is {1} items, and asked to keep {2} items at the same time, while you have {3} extra items like Lucky Eggs/Incubators/etc..."),

            new KeyValuePair<TranslationString, string>(TranslationString.ReadTos,
                "Just read the Niantic ToS, looks legit, accepting!"),
            new KeyValuePair<TranslationString, string>(TranslationString.GenderSelect,
                "Selected your avatar, now you are {0}!"),
            new KeyValuePair<TranslationString, string>(TranslationString.TutorialPokestop,
                "First time experience complete, looks like i just spinned an virtual pokestop :P"),
            new KeyValuePair<TranslationString, string>(TranslationString.TutorialPoke,
                "Caught Tutorial pokemon! it's {0}!"),
            new KeyValuePair<TranslationString, string>(TranslationString.TutorialNameNotPicked,
                "You didn't pick the desired nickname!"),
            new KeyValuePair<TranslationString, string>(TranslationString.TutorialNameTooLong,
                "You selected too long Desired name, max length: 15!"),
            new KeyValuePair<TranslationString, string>(TranslationString.TutorialNameDone,
                "Your name is now: {0}"),
            new KeyValuePair<TranslationString, string>(TranslationString.TutorialNameFailed,
                "Name selection failed! Error: {0}"),
            new KeyValuePair<TranslationString, string>(TranslationString.TutorialNameErrorUnset,
                "Unset, somehow"),
            new KeyValuePair<TranslationString, string>(TranslationString.TutorialNameErrorChanged,
                "No errors, nickname changed"),
            new KeyValuePair<TranslationString, string>(TranslationString.TutorialNameErrorNotAvail,
                "That nickname isn't available, pick another one and restart the bot!"),
            new KeyValuePair<TranslationString, string>(TranslationString.TutorialNameErrorNotValid,
                "That nickname isn't valid, pick another one!"),
            new KeyValuePair<TranslationString, string>(TranslationString.TutorialNameErrorOwner,
                "You already own that nickname!"),
            new KeyValuePair<TranslationString, string>(TranslationString.TutorialNameErrorNoMore,
                "You can't change your nickname anymore!"),
            new KeyValuePair<TranslationString, string>(TranslationString.CantGetAPIVersion,
                "Unable to get API version Information"),
            new KeyValuePair<TranslationString, string>(TranslationString.OldAPIErr,
                "Catchem API version is less than the minimum stop botting to avoid ban!"),
            new KeyValuePair<TranslationString, string>(TranslationString.APIVersionOK,
                "Catchem API Version {0}, Minimum API Version {1}"),
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.EncounterProblemPokemonFlee,
                "Encounter Pokemon Fled {0}!"),
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.CheckingForMaximumInventorySize,
                // added by Lars
                "[Inventory] Items to Keep exceeds maximum inventory size! {0}/{1}"),
            new KeyValuePair<TranslationString, string>(TranslationString.LogEntryFavorite, "FAVORITE"),
            // added by Lars
            new KeyValuePair<TranslationString, string>(TranslationString.LogEntryUnFavorite, "UNFAVORITE"),
            // added by Lars
            new KeyValuePair<TranslationString, string>(TranslationString.PokemonFavorite, "{0}"),
            //pre-formatted - added by Lars
            new KeyValuePair<TranslationString, string>(TranslationString.PokemonUnFavorite, "{0}"),
            //pre-formatted - added by Lars
            new KeyValuePair<TranslationString, string>(TranslationString.WalkingSpeedRandomized, "{0}"),
            //pre-formatted - added by Lars
            new KeyValuePair<TranslationString, string>(TranslationString.StopBotToAvoidBan,
                "The bot was stopped to avoid ban!"), // added by Lars
            new KeyValuePair<TranslationString, string>(TranslationString.BotNotStoppedRiskOfBan,
                "Somethng happened that shouldn't have and bot hasn't stopped. Higher possibility of ban. (suggested action: stop the bot \"Control+C\").")
            // added by Lars
        };
        ...
        public string GetTranslation(TranslationString translationString, params object[] data)
        {
            try
            {
                ...
                {
                    translation = TranslationStrings.FirstOrDefault(t => t.Key.Equals(translationString)).Value;
                }
        ...
        public static void InsertMissedLines()
        {
            var translationPath = Path.Combine("Config", "Translations");
            foreach (var f in Directory.GetFiles(translationPath))
            {
                try
                {
                    ...
                    if (fi.Extension.ToLower() == ".json")
                    {
                        ...
                        jsonSettings.Error += delegate(object sender, ErrorEventArgs args)
                        {
                            args.ErrorContext.Handled = true;
                        };

                        var translations = JsonConvert.DeserializeObject<Translation>(input, jsonSettings);
                        TranslationStrings.Where(
                            item => translations._translationStrings.All(a => a.Key != item.Key))
                            .ToList()
                            .ForEach(translations._translationStrings.Add);
                        translations.Save(fi.FullName);
                    }
                }
                catch (Exception ex)
                {
                    Logging.Logger.Write("[Translation check failed] " + ex.Message);
                    //ignore throw;
                }
            }
        }
