...
namespace PoGo.PokeMobBot.Logic
{
    ...
    public class TransferFilter
    {
        ...
        public TransferFilter(PokemonId id, int keepMinCp, float keepMinIvPercentage, int keepMinDuplicatePokemon)
        {
            Id = id;
            KeepMinCp = keepMinCp;
    ...
    public interface ILogicSettings
    {
        ...
        bool AutoUnfavoritePokemon { get; }
        ...
        bool RestartBotOnFailure { get; }
        int FailureRestartDelay { get; }
        int FailureMaxRetries { get; }
        ...
        ICollection<TransferFilter> PokemonsTransferFilter { get; }
