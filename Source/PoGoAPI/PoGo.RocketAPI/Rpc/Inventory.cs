...
namespace PokemonGo.RocketAPI.Rpc
{
    public class Inventory : BaseRpc
    {
        ...
        public async Task<GetInventoryResponse> GetInventory(long lastInventoryPullMs)
        {
            return await PostProtoPayload<Request, GetInventoryResponse>(RequestType.GetInventory, new GetInventoryMessage()
            {
                LastTimestampMs = lastInventoryPullMs
            });
        }
        ...
        {
            var message = new GetBuddyWalkedMessage();
            return await PostProtoPayload<Request, GetBuddyWalkedResponse>(RequestType.GetBuddyWalked, message);
        }
