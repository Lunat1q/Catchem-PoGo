...
namespace Catchem.Pages
{
    ...
    public partial class SettingsPage : IBotPage
    {
        ...
        {
            c_DeviceId.Text = DeviceSettings.RandomString(32, "0123456789abcdef"); //iOS - 32, Android - 16
        }
        ...
        private async void StartFillFromRealDevice()
        {
            ...
            Bot.GlobalSettings.Device.DeviceModelBoot = dd.DeviceModelBoot;
        ...
        private void FillBoxesFromSettings()
        {
            ...
            c_DeviceModelBoot.Text = Bot.GlobalSettings.Device.DeviceModelBoot;
        ...
        private async void btn_textProxy_Click(object sender, RoutedEventArgs e)
        {
